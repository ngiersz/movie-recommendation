...
send_request_and_print('GET', 'http://127.0.0.1:5000/avg-genre-ratings/all-users')
send_request_and_print('GET', 'http://127.0.0.1:5000/profile?user=80')
